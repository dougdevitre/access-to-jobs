...
not connections. This means the application process is more structured, more documentation-heavy,
and more transparent than private-sector hiring.
...
1. **Vacancy announcement posted** on USAJobs.gov with specific requirements
2. **Application window** — typically 5–30 days (apply early; some close when a set number apply)
3. **HR specialist reviews** — screens for minimum qualifications (education + experience)
4. **Referred to hiring manager** — only if you meet all requirements and score high enough
5. **Interview** — usually structured, panel-based
6. **Tentative offer** → background check → **final offer**

### Federal Resume Format

Federal resumes are NOT the same as private-sector resumes. They are **longer, more detailed,
...
— work that directly relates to the position's duties at the next lower grade level.
...
Some federal announcements require separate KSA narratives. Even when not required,
the self-assessment questionnaire functions like a KSA.
...
Local government (cities, counties, school districts, special districts) hiring varies
by jurisdiction but generally follows merit principles.
...
**How it works:** After a scored examination, preference points are added to passing scores.
For non-scored evaluations, veterans who meet qualifications are placed ahead of non-veterans
...
1. Claim veteran preference on the application
2. Attach DD-214 (Member-4 copy)
3. Attach VA disability rating letter if applicable
4. Translate MOS/rating to civilian government job titles
5. Contact the agency's Veterans Employment Program Manager for guidance
...
Schedule A is a **non-competitive hiring authority** that allows federal agencies to hire
individuals with severe physical, psychiatric, or intellectual disabilities without going
through the traditional competitive hiring process.
...
**How it works:**
1. Obtain a Schedule A letter (your VR counselor, doctor, or therapist can provide one)
2. Identify positions of interest on USAJobs or agency websites
3. Contact the agency's Selective Placement Program Coordinator (SPPC)
4. Submit your resume and Schedule A letter
5. If you meet minimum qualifications, you can be hired directly without competition
